  ...
  return (
    <nav
      className={cn(
        ...
        scrolled ? "glass shadow-md py-2" : "bg-transparent border-b-2 border-b-blue-400"
      )}
    >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="lg:hidden bg-white/95 backdrop-blur-lg overflow-hidden border-t mt-3"
          >
