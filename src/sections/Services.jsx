...
const Services = () => {
  const services = [
    ...
    {
      title: "Konsultasi IT",
      desc: "Memberikan saran dan solusi untuk membantu bisnis dalam mengoptimalkan teknologi informasi.",
      icon: ExternalLink,
      color: "blue"
    },
        ...
        {services.map((service, index) => (
          ...
          >
            ...
            <div className="relative z-10 flex-grow">
              <h3 className="text-sm font-black text-professional mb-3 group-hover:text-primary transition-colors">{service.title}</h3>
              <p className="text-professional/60 text-xs leading-relaxed mb-6">{service.desc}</p>
            </div>
